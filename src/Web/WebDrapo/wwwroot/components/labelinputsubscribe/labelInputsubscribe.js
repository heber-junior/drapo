...
function labelinputsubscribeConstructor(el, app) {
    return __awaiter(this, void 0, void 0, function* () {
        let instance = new LabelInputSubscribe(el, app);
...
class LabelInputSubscribe {
    ...
    Initalize() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let instance = this;
            this._app.Observer.SubscribeComponent(dataKey, this._el, () => __awaiter(this, void 0, void 0, function* () { yield instance.Notify(); }));
            yield this.Notify();
        });
    }
    Notify() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let dataItem = yield this._app.Storage.RetrieveData(dataKey, this._sector);
...
//# sourceMappingURL=labelInputsubscribe.js.map